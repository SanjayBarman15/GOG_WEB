      ...
      <div className="frame83">
        <div className="frame81">
          ...
          <p className="frame81-paragraph">
            In the current educational landscape, students from tier 2 and tier
            3 cities often face significant disadvantages in terms of skill
            development and educational resources. The major edtech companies,
            despite their substantial funding, predominantly cater to tier 1
            cities, leaving a significant portion of India's population
            underserved. Recognizing this gap, we founded Geeks of Gurukul with
            the primary mission of Empowering Bharat, focusing specifically on
